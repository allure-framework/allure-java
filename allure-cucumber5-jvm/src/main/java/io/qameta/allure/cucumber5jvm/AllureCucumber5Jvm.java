...
/**
 * Reports Cucumber JVM 5 execution to Allure.
 *
...
public class AllureCucumber5Jvm implements ConcurrentEventListener {
    ...
    /**
     * Creates an Allure cucumber5 jvm with default configuration.
     */
    ...
    /**
     * Creates an Allure cucumber5 jvm with the supplied values.
     *
