...
dependencies {
    ...
    compileOnly("org.scala-lang.modules:scala-collection-compat_$scala213:2.13.0")
    ...
    testImplementation("org.scala-lang.modules:scala-collection-compat_$scala213:2.13.0")
