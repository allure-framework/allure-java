 ...
 *
 * <p>The model stores selected test cases and helper lookup methods used by framework integrations.
 * It is typically created by deserializing an Allure test plan JSON file.</p>
 */
